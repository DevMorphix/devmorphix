...
const projects: Project[] = [
  {
    ...
    description: "Official website and member portal for Inovus Labs Innovation and Entrepreneurship Development Cell."
  },
  {
    id: 2,
    title: "GigWork",
    ...
    description: "The ultimate online business directory accessible through WhatsApp. We are dedicated to connecting local businesses with customers in the most efficient way possible."
  }
];
    ...
    <section className="pt-32 pb-24 bg-aura-surface text-aura-light min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div>
            <span className="text-aura-gold uppercase tracking-widest text-sm mb-2 block">Selected Works</span>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-2xl font-serif mb-1 group-hover:text-aura-gold transition-colors">{project.title}</h3>
                  <p className="text-aura-sand/60 text-sm uppercase tracking-wider mb-3">{project.category}</p>
                </div>
                <span className="text-aura-dark bg-aura-sand/20 px-3 py-1 text-xs rounded-full text-aura-sand">2024</span>
              </div>
